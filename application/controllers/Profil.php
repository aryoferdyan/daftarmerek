...
class Profil extends CI_Controller
{
    ...
    public function index()
    {
        ...
        // Redirect ke halaman update dengan menggunakan ID user dari session
        redirect(site_url('profil/update/' . $id_user));
    }
    ...
    public function read($id)
    {
        ...
        if ($row) {
            ...
            $this->template->load('template', 'Profil/tbl_user_read', $data);
        } else {
    ...
    public function update($id)
    {
        ...
        if ($row) {
            ...
            $this->template->load('template', 'profil/tbl_user_form', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('profil/update' . $data['id_users']));
        }
    }
    ...
    public function update_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->Profil_model->update($this->input->post('id_users', TRUE), $data);
    ...
    public function word()
    {
        ...
        $data = array(
            'tbl_user_data' => $this->Profil_model->get_all(),
            'start' => 0
        );
