...
// Assuming $resultLog is a valid MySQLi result object
while ($row = $resultLog->fetch_assoc()) {
    $dataLog[] = $row; // Append each row to the $dataLog array
}
...
<script>
        ...
        createChart('permohonanChart', permohonanData, 'Total Permohonan', 'rgba(75, 192, 192, 0.2)');
        createChart('logChart', logData, 'Total Log', 'rgba(255, 99, 132, 0.2)');
    </script>
